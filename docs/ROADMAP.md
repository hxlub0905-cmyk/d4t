...
| **Measure** | **Gray level ✅ 收斂 2026-08-21（F18）** ＋ **CD ✅ 收斂 2026-08-21（F19）** —— 見下面兩段。剩下：離群旗標（跨顆 —— 要 `lot baseline` 那一層）、Region Stats / FFT、`snr_map` 多來源。~~Blob 分割~~ **不做**（使用者 2026-08-20：「不需要 也不要再出現」）|
