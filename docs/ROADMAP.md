...
| 分支路徑稽核（F9-8…F9-10） | ✅ 2026-08-16 | 四個「跑得完、有數字、而且是錯的」全部修完並鎖上迴歸測試：快取簽章含線、停用的卡沿線讓路、一對節點可以有好幾條線、快照存得下流的身分。見 [`plans/F9-dag-streams.md`](plans/F9-dag-streams.md) §12–14 |
