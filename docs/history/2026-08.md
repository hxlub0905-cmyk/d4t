# SESSION_LOG —— 2026 年 8 月（前半）封存

從 `SESSION_LOG.md` 搬過來（2026-08-20）。**內容一個字都沒有改**，只是換個地方
住 —— 見 [`README.md`](README.md)。

這一段是 **2026-08-07 ～ 08-18**：F7-23／F7-24 收尾、F8 純規則 ROI、畫布 n8n 化、
D 案版面、Phase 1 收斂、專案整理與封存、F10「畫布要符合現實」、Phase 2 開工
（計畫書 F11、Input 段做齊、Enhance 段收斂）、Region 段從 Template 一路做到收斂。

第一輪（**第十五輪，Region 段收斂**）是**上一次合併進 `main`** 的那一輪 ——
所以這一份等於「main 到那個時間點為止的開發紀錄」，而 `SESSION_LOG.md` 留下的
是那之後的事。
...
**開工前讀**：[`AGENTS.md`](../../AGENTS.md) → [`docs/plans/F11-phase2-features.md`](../plans/F11-phase2-features.md)
...
1. [`AGENTS.md`](../../AGENTS.md) —— 兩台機器、剪貼簿是唯一通道（不知道會把必要的設計
   當成過度設計刪掉）
2. [`docs/plans/F11-phase2-features.md`](../plans/F11-phase2-features.md) **§3.3**
...
只讀 code、寫計畫書（[`docs/plans/F11-phase2-features.md`](../plans/F11-phase2-features.md)）、
順手修兩處會害人做錯事的文件漂移。
...
[`docs/history/plans/F10-canvas-tells-the-truth.md`](plans/F10-canvas-tells-the-truth.md)。
...
計畫書 `docs/history/plans/F8-rule-based-roi.md`。
