...
> 狀態：**✅ 完成。** 引擎 2026-08-23、Studio 上的編輯 2026-08-23（F22-UI）、
> 畫布那一半 2026-08-24（由 F24 的判定樹接手，見那一份 §1）。§6 的開放問題
> （ADC 要不要有線）2026-08-24 定稿 —— 有，而且是一整個判定區，不是每張卡各一條。
> §4「還沒做的」那張表在 F24／F25 一路清空，逐項紀錄在 `SESSION_LOG.md`。
