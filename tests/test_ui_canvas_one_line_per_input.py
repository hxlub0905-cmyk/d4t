# 線由使用者拉，一個輸入埠只有一條（常駐）—— 鐵則 10 的正典。
# 起於 F9-7，authored 2026-08-16；2026-08-27 從
# `test_ui_f9_7_user_draws_the_lines.py` 改名（F39 A 組）。
# ⚠ `ambiguous-input` 這條 lint 全 repo 只有這一支在測。
...
from d4t.core.pipeline.recipe import validate     # noqa: E402
