# d4t M3 背景工作層測試 — authored 2026-07-28.
"""``d4t.ui.workers`` 的 headless 測試（QT_QPA_PLATFORM=offscreen）。
...
★ 為什麼 Qt 是「延遲匯入」★
  ...
  d4t.ui.workers``（它自己 import PySide6），那道守門測試就會被這裡的
  import 汙染而失敗。
...
def qt():
    ...
    import d4t.ui.workers as workers_mod
