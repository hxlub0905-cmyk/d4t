# FlexADC Studio 背景工作層 — authored 2026-07-28 (M3).
...
from flexadc.core.ingest.dataset import Dataset, load_dataset
from flexadc.core.pipeline import Recipe, run_batch, run_defect
from flexadc.core.pipeline.engine import DefectResult
...
class TrialWorker(_ThreadedWorker):
    """在背景跑 :func:`flexadc.core.pipeline.run_batch`（前 N 顆試跑）。
