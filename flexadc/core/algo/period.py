...
#     the FlexADC M4 phase-search milestone.
...
def choose_origin(shape: Tuple[int, ...], px: Optional[int],
    ...
    TODO(FlexADC M4): replace this stub with a proper phase search that
    ...
    ``flexadc.core.algo.golden.stack_cells`` / ``ghosting_score``).
    """
    return (0, 0)
