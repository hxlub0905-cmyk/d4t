...
#     primitive lives in `flexadc.core.algo.snr` (see comment below).
...
# two raw pixel arrays lives in `flexadc.core.algo.snr` (maintained
...
def group_snr(image: np.ndarray, rois: List[ROI],
    ...
    e-beam SNR convention (see `flexadc.core.algo.snr`).
    """
